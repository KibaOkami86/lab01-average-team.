# Exercise 01 (Setup and GroupInfo)
...
1. Create a file named `GroupInfo.md` in the Exercise01 folder
2. Edit this file adding information about the components of your group in the following format:

`Name` `Surname` `UniversityID(Matricola)` `Email address` `Github username`

add 1 line for each component of the group
